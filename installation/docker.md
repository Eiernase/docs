...
We host our offical docker image on Docker Hub https://hub.docker.com/r/leantime/leantime. Your device needs to have Docker Installed. Please check the [Official Docker](https://docs.docker.com/get-docker/) page, if you don't have Docker installed
